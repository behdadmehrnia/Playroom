...
TEXTBOOK_BOOK_UNAVAILABLE_INSTRUCTION = (
    ...
    "مهربان و کوتاه بگو این کتاب برای آن کلاس/پایه در کتاب‌های مدرسه‌ای که می‌شناسی نیست "
    "(اگر پایه‌های موجود در کانتکست آمده، همان‌ها را بگو؛ مثلاً «کار و فناوری برای پایه ششم است»). "
    "پیشنهاد بده کتاب درست را بگوید، یا اگر تمرین از کتاب دیگری است نامش را بگوید، "
    "یا عکس صفحه / متن سوال را بفرستد. "
