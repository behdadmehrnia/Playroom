...
TEXTBOOK_PAGE_OUT_OF_RANGE_INSTRUCTION = (
    ...
    "و بخواه یک صفحهٔ معتبر داخل کتاب، یا شمارهٔ درس/فصل، یا یک خط از تمرین را بگوید. "
...
TEXTBOOK_LESSON_MISSING_INSTRUCTION = (
    ...
    "مهربان بگو الان آن درس را دقیق پیدا نکردی و بخواه "
    "شمارهٔ صفحه، یا نام/موضوع درس، یا یک خط از تمرین را بگوید. "
...
TEXTBOOK_NEED_INFO_INSTRUCTION = (
    ...
    "اگر درس/فصل را گفته، شمارهٔ صفحه را اجباری نپرس مگر واقعاً لازم باشد. "
